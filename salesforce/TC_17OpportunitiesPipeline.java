...
public class TC_17OpportunitiesPipeline extends BaseTest{
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		System.out.println("Opportunity Pipeline Page: "+oppoText);
		String expectedOppoText = "Opportunity Pipeline ~ Salesforce - Developer Edition";
		if(oppoText.equalsIgnoreCase(expectedOppoText)) {
			System.out.println("Opportunity Pipeline page displayed");
		}
		else {
			System.out.println("Opportuinity Pipeline page not displayed");
		}
