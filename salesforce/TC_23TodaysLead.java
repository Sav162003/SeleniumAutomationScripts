...
public class TC_23TodaysLead extends BaseTest {
	...
	// Todays Lead
		...
		System.out.println("Lead Page: "+leadsPage);
		String expectedLead = "Leads ~ Salesforce - Developer Edition";
		if(leadsPage.equalsIgnoreCase(expectedLead)) {
